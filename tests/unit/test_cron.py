...
def test_setup_no_setup(monkeypatch: pytest.MonkeyPatch):
    ...
    cron.setup(interval=MagicMock(), unit_name=MagicMock(), action_name=MagicMock())
...
def test_setup_disable_cron(monkeypatch: pytest.MonkeyPatch):
    ...
    cron.setup(interval=0, unit_name=MagicMock(), action_name=MagicMock())
...
def test_setup(monkeypatch: pytest.MonkeyPatch):
    ...
    cron.setup(interval=1, unit_name=MagicMock(), action_name=MagicMock())
