...
"""Delete stale OpenStack resources left by interrupted app integration runs."""
...
_SG_PATTERNS: tuple[re.Pattern[str], ...] = (
    re.compile(r"^github-runner-image-builder-test-security-group-"),
)
...
def cleanup_stale_openstack_resources(
    ...
    """Remove app-IT OpenStack leftovers older than ``min_age``."""
